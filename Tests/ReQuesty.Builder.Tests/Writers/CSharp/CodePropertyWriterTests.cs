...
public sealed class CodePropertyWriterTests : IDisposable
{
    ...
    public CodePropertyWriterTests()
    {
        ...
        CodeClass derivedClass = rootNamespace.AddClass(new CodeClass
        {
    ...
    public void DoesntWritePropertiesExistingInParentType()
    {
        ...
        CodeClass subClass = (parentClass.Parent as CodeNamespace)!.AddClass(new CodeClass
        {
            Name = "BaseClass",
        }).First();
        ...
        CodeProperty propertyToWrite = subClass.AddProperty(new CodeProperty
        {
            Name = "definedInParent",
            Type = new CodeType
            {
    ...
    public void DisambiguateAmbiguousImportedTypes()
    {
        ...
        CodeNamespace defaultNamespace = rootNamespace.AddNamespace("models");
        CodeClass testModel = defaultNamespace.AddClass(
            new CodeClass
            {
        ...
        CodeNamespace levelOneNameSpace = rootNamespace.AddNamespace("namespaceLevelOne");
        CodeClass anotherDerivedClass = levelOneNameSpace.AddClass(
            new CodeClass
            {
                Name = "SomeCustomClass"
            }).First();
        levelOneNameSpace.AddClass(anotherDerivedClass);
        CodeProperty conflictingProperty = new()
        {
            Name = $"{PropertyName}2",
            Type = new CodeType
            {
    ...
    public void WritesMessageOverrideOnPrimary()
    {
        ...
        CodeProperty overrideProperty = parentClass.AddProperty(new CodeProperty
        {
            Name = "Message",
