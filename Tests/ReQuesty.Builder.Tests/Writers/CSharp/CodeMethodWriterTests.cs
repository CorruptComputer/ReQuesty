...
public sealed class CodeMethodWriterTests : IDisposable
{
    ...
    private void AddSerializationProperties()
    {
        ...
        CodeClass complexTypeClass = root.AddClass(new CodeClass
        {
        ...
        CodeEnum enumDefinition = root.AddEnum(new CodeEnum
        {
            Name = "EnumType"
        }).First();
        parentClass.AddProperty(new CodeProperty
    ...
    {
        CodeClass complexType1 = root.AddClass(new CodeClass
        {
            Name = "ComplexType1",
            Kind = CodeClassKind.Model,
        }).First();
        CodeClass complexType2 = root.AddClass(new CodeClass
        {
            Name = "ComplexType2",
            Kind = CodeClassKind.Model,
        }).First();
        CodeClass unionTypeWrapper = root.AddClass(new CodeClass
        {
        ...
        unionTypeWrapper.DiscriminatorInformation.AddDiscriminatorMapping("#requesty.complexType1", new CodeType
        {
            Name = "ComplexType1",
            TypeDefinition = cType1
        });
        unionTypeWrapper.DiscriminatorInformation.AddDiscriminatorMapping("#requesty.complexType2", new CodeType
        {
            Name = "ComplexType2",
    ...
    private CodeClass AddIntersectionTypeWrapper()
    {
        ...
        CodeClass complexType3 = root.AddClass(new CodeClass
        {
            Name = "ComplexType3",
            Kind = CodeClassKind.Model,
        }).First();
        CodeClass intersectionTypeWrapper = root.AddClass(new CodeClass
        {
        ...
        intersectionTypeWrapper.DiscriminatorInformation.AddDiscriminatorMapping("#requesty.complexType1", new CodeType
        {
            Name = "ComplexType1",
            TypeDefinition = cType1
        });
        intersectionTypeWrapper.DiscriminatorInformation.AddDiscriminatorMapping("#requesty.complexType2", new CodeType
        {
            Name = "ComplexType2",
            TypeDefinition = cType2
        });
        intersectionTypeWrapper.DiscriminatorInformation.AddDiscriminatorMapping("#requesty.complexType3", new CodeType
        {
            Name = "ComplexType3",
    ...
    public void WritesRequestExecutorBody()
    {
        ...
        CodeClass error4XX = root.AddClass(new CodeClass
        {
            Name = "Error4XX",
        }).First();
        CodeClass error5XX = root.AddClass(new CodeClass
        {
            Name = "Error5XX",
        }).First();
        CodeClass error401 = root.AddClass(new CodeClass
        {
            Name = "Error401",
        }).First();
    ...
    public void WritesRequestExecutorBodyWithUntypedReturnValue()
    {
        ...
        method!.Kind = CodeMethodKind.RequestExecutor;
        method.HttpMethod = HttpMethod.Get;
        method.ReturnType = new CodeType { TypeDefinition = null, Name = ReQuestyBuilder.UntypedNodeName };
        CodeClass errorXXX = root.AddClass(new CodeClass
        {
            Name = "ErrorXXX",
        }).First();
    ...
    {
        setup();
        CodeClass wrapper = AddUnionTypeWrapper();
        CodeMethod factoryMethod = wrapper.AddMethod(new CodeMethod
        {
            Name = "factory",
        ...
        Assert.Contains("if(\"#requesty.complexType1\".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))", result);
    ...
    public void WritesModelFactoryBodyForUnionPrimitiveTypes()
    {
        ...
        CodeMethod factoryMethod = unionTypeWrapper.AddMethod(new CodeMethod
        {
            Name = "factory",
            Kind = CodeMethodKind.Factory,
            ReturnType = new CodeType
    ...
    {
        setup();
        CodeClass wrapper = AddIntersectionTypeWrapper();
        CodeMethod factoryMethod = wrapper.AddMethod(new CodeMethod
        {
            Name = "factory",
            Kind = CodeMethodKind.Factory,
        ...
        Assert.DoesNotContain("if(\"#requesty.complexType1\".Equals(mappingValue, StringComparison.OrdinalIgnoreCase))", result);
    ...
    public void WritesModelFactoryBodyAndDisambiguateAmbiguousImportedTypes()
    {
        ...
        CodeNamespace modelsNamespace = root.AddNamespace("models");
        CodeClass modelWithConflictingDiscriminatorTypes = modelsNamespace.AddClass(
            new CodeClass
            {
        ...
        CodeNamespace levelOneNameSpace = modelsNamespace.AddNamespace("namespaceLevelOne");
        CodeClass conflictingModelInOtherNamespace = levelOneNameSpace.AddClass(
            new CodeClass
            {
        ...
        CodeNamespace levelTwoNameSpace = modelsNamespace.AddNamespace("namespaceLevelTwo");
        CodeEnum conflictingEnumInOtherNamespace = levelTwoNameSpace.AddEnum(
            new CodeEnum()
            {
                Name = "ConflictingModel"
            }).First();
        ...
        CodeMethod factoryMethod = modelWithConflictingDiscriminatorTypes.AddMethod(new CodeMethod
        {
            Name = "factory",
            Kind = CodeMethodKind.Factory,
            ReturnType = new CodeType
    ...
    {
        setup();
        CodeClass parentModel = root.AddClass(new CodeClass
        {
            Name = "parentModel",
            Kind = CodeClassKind.Model,
        }).First();
        CodeClass childModel = root.AddClass(new CodeClass
        {
            Name = "childModel",
            Kind = CodeClassKind.Model,
        }).First();
        ...
        CodeMethod factoryMethod = parentModel.AddMethod(new CodeMethod
        {
            Name = "factory",
            Kind = CodeMethodKind.Factory,
            ReturnType = new CodeType
    ...
    public void WritesUnionDeSerializerBody()
    {
        setup();
        CodeClass wrapper = AddUnionTypeWrapper();
        CodeMethod deserializationMethod = wrapper.AddMethod(new CodeMethod
        {
    ...
    public void WritesUnionSerializerBody()
    {
        setup();
        CodeClass wrapper = AddUnionTypeWrapper();
        CodeMethod serializationMethod = wrapper.AddMethod(new CodeMethod
        {
            Name = "factory",
    ...
    public void WritesConstructor()
    {
        ...
        string defaultValue = "someVal";
        string propName = "propWithDefaultValue";
        parentClass.AddProperty(new CodeProperty
        {
            Name = propName,
        ...
        string defaultValueNull = "\"null\"";
        string nullPropName = "propWithDefaultNullValue";
        parentClass.AddProperty(new CodeProperty
        {
            Name = nullPropName,
        ...
        string defaultValueBool = "\"true\"";
        string boolPropName = "propWithDefaultBoolValue";
        parentClass.AddProperty(new CodeProperty
        {
            Name = boolPropName,
        ...
        string defaultValueEscapedLineBreak = "\"someVal\n\"";
        string expectedValueEscapedLineBreak = @"""someVal\n""";
        string escapedLineBreakPropName = "propWithDefaultEscapedLineBreak";
        parentClass.AddProperty(new CodeProperty
        {
        ...
        string defaultValueEscapedQuotes = "\"this is \"surrounded by quotes\"\"";
        string expectedValueEscapedQuotes = @"""this is \""surrounded by quotes\""""";
        string escapedQuotesPropName = "propWithDefaultEscapedQuotes";
        parentClass.AddProperty(new CodeProperty
        {
    ...
    public void WritesConstructorWithEnumValue()
    {
        ...
        CodeNamespace modelsNamespace = root.AddNamespace("models");
        method.Kind = CodeMethodKind.Constructor;
        string defaultValue = "1024x1024";
        string propName = "size";
        CodeEnum codeEnum = modelsNamespace.AddEnum(new CodeEnum
        {
            Name = "pictureSize"
        }).First();
        parentClass.AddProperty(new CodeProperty
    ...
    public void WritesApiConstructor()
    {
        ...
        CodeProperty coreProp = parentClass.AddProperty(new CodeProperty
        {
            Name = "core",
            Kind = CodePropertyKind.RequestAdapter,
            Type = new CodeType
        ...
        method.DeserializerModules = ["com.microsoft.requesty.serialization.Deserializer"];
        method.SerializerModules = ["com.microsoft.requesty.serialization.Serializer"];
        writer.Write(method);
        string result = tw.ToString();
        Assert.Contains(parentClass.Name.ToFirstCharacterUpperCase(), result);
    ...
    public void WritesApiConstructorWithBackingStore()
    {
        ...
        LanguageWriter tempWriter = LanguageWriter.GetLanguageWriter(GenerationLanguage.CSharp, DefaultPath, DefaultName);
