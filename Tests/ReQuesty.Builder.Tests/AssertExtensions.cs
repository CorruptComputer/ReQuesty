...
public static class AssertExtensions
{
    ...
    {
        int openingSymbolIndex = generatedCode.IndexOf(blockOpeningSymbol, generatedCode.IndexOf(blockOpening, comparison), comparison);
        int closingSymbolIndex = GetClosingBlockIndex(generatedCode, openingSymbolIndex, blockOpeningSymbol, blockClosingSymbol, comparison);
    ...
    {
        int closingBlockIndex = generatedCode.IndexOf(blockClosingSymbol, startupLookupIndex, comparison);
