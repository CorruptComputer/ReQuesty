...
public sealed class OpenApiAiRespondingInstructionsExtensionTests : IDisposable
{
    ...
    public void Parses()
    {
        ...
        OpenApiAiRespondingInstructionsExtension value = OpenApiAiRespondingInstructionsExtension.Parse(oaiValue!);
...
info:
  ...
  x-ai-responding-instructions:
    ...
    - This is a description 2";
        ...
        Mock<ILogger<OpenApiAiRespondingInstructionsExtension>> mockLogger = new();
        ...
        Assert.True(document.Info.Extensions!.TryGetValue(OpenApiAiRespondingInstructionsExtension.Name, out IOpenApiExtension? descriptionExtension));
    ...
    {
        OpenApiAiRespondingInstructionsExtension value = new()
        {
