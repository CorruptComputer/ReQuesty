...
public static class ValidationRuleSetExtensions
{
    ...
    public static void AddReQuestyValidationRules(this ValidationRuleSet ruleSet, GenerationConfiguration configuration)
    {
        ArgumentNullException.ThrowIfNull(ruleSet);
        configuration ??= new();
        if (configuration.DisabledValidationRules.Contains(AllValidationRule))
        {
            return;
        }
